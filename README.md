...
Built on the lognpacific cyber-range platform by Josh Madakor, with custom detection rules, DFIR analysis, and this write-up as original work on top of that lab environment.
